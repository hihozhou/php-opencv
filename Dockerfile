...
RUN apt-get update && export DEBIAN_FRONTEND=noninteractive && apt-get install -y  pkg-config cmake git php-cli php-dev qt5-default
...
RUN git clone --depth 1 https://gitee.com/hihozhou/opencv.git
